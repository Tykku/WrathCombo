...
| `/wrath burst custom`                  | Toggles all features you have enabled as part of the Advanced Mode custom burst settings.                                                                                      |
...
| `/wrath burst custom <X>`              | Sets all features you have enabled as part of the Advanced Mode custom burst settings to a specific state.<br>Replace `<X>` with `enable` or `disable`.                        |
