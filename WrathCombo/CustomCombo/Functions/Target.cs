...
internal abstract partial class CustomComboFunctions
{
    ...
    public static bool CanInterruptEnemy(float? minCastPercent = null, IGameObject? optionalTarget = null)
    {
        ...
        float minThreshold = Math.Clamp(minCastPercent ?? Service.Configuration.InterruptDelay, 0f, 100f);
        ...
        IGameObject? optionalTarget = null)
    {
        ...
        var minThreshold = Math.Clamp(minCastPercent ?? Service.Configuration.InterruptDelay, 0f, 100f);
